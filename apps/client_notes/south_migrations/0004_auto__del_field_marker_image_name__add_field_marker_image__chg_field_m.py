...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Marker.image_name'
        db.delete_column(u'client_notes_marker', 'image_name')

        # Adding field 'Marker.image'
        db.add_column(u'client_notes_marker', 'image',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Marker.color'
        db.alter_column(u'client_notes_marker', 'color', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

    def backwards(self, orm):
        # Adding field 'Marker.image_name'
        db.add_column(u'client_notes_marker', 'image_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Marker.image'
        db.delete_column(u'client_notes_marker', 'image')


        # Changing field 'Marker.color'
        db.alter_column(u'client_notes_marker', 'color', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
