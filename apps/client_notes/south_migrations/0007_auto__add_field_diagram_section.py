...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diagram.section'
        db.add_column(u'client_notes_diagram', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['client_notes.Section']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Diagram.section'
        db.delete_column(u'client_notes_diagram', 'section_id')
