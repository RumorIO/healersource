...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dot.text'
        db.alter_column(u'client_notes_dot', 'text', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Dot.text'
        db.alter_column(u'client_notes_dot', 'text', self.gf('django.db.models.fields.CharField')(max_length=250))
