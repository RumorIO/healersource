...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.code_name'
        db.add_column(u'client_notes_section', 'code_name',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50),
                      keep_default=False)

        # Adding unique constraint on 'Diagram', fields ['code_name']
        db.create_unique(u'client_notes_diagram', ['code_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Diagram', fields ['code_name']
        db.delete_unique(u'client_notes_diagram', ['code_name'])

        # Deleting field 'Section.code_name'
        db.delete_column(u'client_notes_section', 'code_name')
