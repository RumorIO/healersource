...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Marker.code_name'
        db.delete_column(u'client_notes_marker', 'code_name')

        # Adding field 'Marker.color'
        db.add_column(u'client_notes_marker', 'color',
    ...
    def backwards(self, orm):
        # Adding field 'Marker.code_name'
        db.add_column(u'client_notes_marker', 'code_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'Marker.color'
        db.delete_column(u'client_notes_marker', 'color')
    ...
    models = {
        ...
        u'client_notes.marker': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'client_notes.note': {
