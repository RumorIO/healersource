...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table(u'client_notes_note', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notes', to=orm['healers.Healer'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Client'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('finalized_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('finalized', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subjective', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('objective', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('assessment', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('plan', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ))
        db.send_create_signal(u'client_notes', ['Note'])

        # Adding model 'Marker'
        db.create_table(u'client_notes_marker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'client_notes', ['Marker'])

        # Adding model 'Diagram'
        db.create_table(u'client_notes_diagram', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'client_notes', ['Diagram'])

        # Adding model 'Dot'
        db.create_table(u'client_notes_dot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dots', to=orm['client_notes.Note'])),
            ('position_x', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('position_y', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('diagram', self.gf('django.db.models.fields.related.ForeignKey')(related_name='diagrams', to=orm['client_notes.Diagram'])),
            ('marker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='markers', to=orm['client_notes.Marker'])),
            ('text', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ))
        db.send_create_signal(u'client_notes', ['Dot'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'client_notes_note')

        # Deleting model 'Marker'
        db.delete_table(u'client_notes_marker')

        # Deleting model 'Diagram'
        db.delete_table(u'client_notes_diagram')

        # Deleting model 'Dot'
        db.delete_table(u'client_notes_dot')
    ...
    models = {
        ...
        u'client_notes.diagram': {
            ...
            'code_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'client_notes.dot': {
