...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAssociationDated'
        db.create_table(u'about_userassociationdated', (
            ('user_assoc', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['oauth_access.UserAssociation'], unique=True, primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'about', ['UserAssociationDated'])


    def backwards(self, orm):
        # Deleting model 'UserAssociationDated'
        db.delete_table(u'about_userassociationdated')
