...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.invite_message'
        db.add_column('clients_client', 'invite_message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.invite_message'
        db.delete_column('clients_client', 'invite_message')
