...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferralsSent'
        db.create_table(u'clients_referralssent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='referral_provider', to=orm['auth.User'])),
            ('client_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='referral_client', null=True, to=orm['auth.User'])),
            ('referring_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='referral_sender', to=orm['auth.User'])),
            ('client_email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True)),
            ...
            ('date_sent', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
        db.send_create_signal(u'clients', ['ReferralsSent'])

        # Adding unique constraint on 'ReferralsSent', fields ['provider_user', 'client_user', 'referring_user']
        db.create_unique(u'clients_referralssent', ['provider_user_id', 'client_user_id', 'referring_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReferralsSent', fields ['provider_user', 'client_user', 'referring_user']
        db.delete_unique(u'clients_referralssent', ['provider_user_id', 'client_user_id', 'referring_user_id'])

        # Deleting model 'ReferralsSent'
        db.delete_table(u'clients_referralssent')
