...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteJoinInvitation.create_friendship'
        db.add_column('clients_sitejoininvitation', 'create_friendship', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteJoinInvitation.create_friendship'
        db.delete_column('clients_sitejoininvitation', 'create_friendship')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 5, 21, 24, 99155)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 5, 21, 24, 99048)'}),
