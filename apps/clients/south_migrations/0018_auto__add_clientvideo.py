...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClientVideo'
        db.create_table('clients_clientvideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videos', to=orm['clients.Client'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')()),
            ('video_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('clients', ['ClientVideo'])


    def backwards(self, orm):
        
        # Deleting model 'ClientVideo'
        db.delete_table('clients_clientvideo')
    ...
    models = {
        ...
        'clients.clientvideo': {
            'Meta': {'object_name': 'ClientVideo'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videos'", 'to': "orm['clients.Client']"}),
