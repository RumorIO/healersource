...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.about'
        db.execute("UPDATE clients_client SET about='' WHERE about IS NULL")
        db.alter_column('clients_client', 'about', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Client.about'
        db.alter_column('clients_client', 'about', self.gf('django.db.models.fields.TextField')(null=True))
