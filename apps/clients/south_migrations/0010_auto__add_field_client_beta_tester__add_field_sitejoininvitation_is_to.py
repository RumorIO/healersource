...
#        db.add_column('clients_client', 'beta_tester', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
        ...
        # Adding field 'SiteJoinInvitation.is_to_healer'
        db.add_column('clients_sitejoininvitation', 'is_to_healer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SiteJoinInvitation.is_to_healer'
        db.delete_column('clients_sitejoininvitation', 'is_to_healer')
