...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.approval_rating'
        db.add_column('clients_client', 'approval_rating', self.gf('django.db.models.fields.PositiveIntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.approval_rating'
        db.delete_column('clients_client', 'approval_rating')
