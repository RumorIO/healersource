...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.link_source'
        db.add_column(u'clients_client', 'link_source',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.link_source'
        db.delete_column(u'clients_client', 'link_source')
