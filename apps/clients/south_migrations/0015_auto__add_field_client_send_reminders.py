...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.send_reminders'
        db.add_column('clients_client', 'send_reminders', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.send_reminders'
        db.delete_column('clients_client', 'send_reminders')
