...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SiteJoinInvitation'
        db.create_table('clients_sitejoininvitation', (
            ('joininvitation_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['friends.JoinInvitation'], unique=True, primary_key=True)),
            ('is_from_site', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('clients', ['SiteJoinInvitation'])


    def backwards(self, orm):
        
        # Deleting model 'SiteJoinInvitation'
        db.delete_table('clients_sitejoininvitation')
