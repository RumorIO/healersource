...
class Migration(DataMigration):
	def forwards(self, orm):
		...
		for location in locations:
			zip_code = Zipcode.objects.filter(
				code=location.location.postal_code)
			if len(zip_code) > 0:
				zip_code = zip_code[0]
				hlocation = location.location
				hlocation.city = title(zip_code.city)
				hlocation.state_province = zip_code.state
				hlocation.save()
	...
	models = {
		...
		u'clients.clientphonenumber': {
			...
			'django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
			'number': (
			'django.db.models.fields.CharField', [], {'max_length': '42'}),
			'type': ('django.db.models.fields.CharField', [],
					 {'default': "'Mobile'", 'max_length': '42'})
		},
		...
		u'clients.referralssent': {
			...
			'object_name': 'ReferralsSent'},
			'client_email': ('django.db.models.fields.EmailField', [],
							 {'max_length': '255', 'null': 'True'}),
			'client_user': ('django.db.models.fields.related.ForeignKey', [],
							{'related_name': "'referral_client'", 'null': 'True',
							 'to': u"orm['auth.User']"}),
			...
			'provider_user': ('django.db.models.fields.related.ForeignKey', [],
							  {'related_name': "'referral_provider'",
							   'to': u"orm['auth.User']"}),
			'referring_user': ('django.db.models.fields.related.ForeignKey', [],
							   {'related_name': "'referral_sender'",
								'to': u"orm['auth.User']"}),
			'type': ('django.db.models.fields.PositiveSmallIntegerField', [],
					 {'default': '0'})
		},
		u'clients.sitejoininvitation': {
			'Meta': {'object_name': 'SiteJoinInvitation',
					 '_ormbases': [u'friends.JoinInvitation']},
			'create_friendship': (
			'django.db.models.fields.BooleanField', [], {'default': 'True'}),
			'is_from_site': (
			'django.db.models.fields.BooleanField', [], {'default': 'False'}),
			'is_to_healer': (
			'django.db.models.fields.BooleanField', [], {'default': 'False'}),
			u'joininvitation_ptr': (
			'django.db.models.fields.related.OneToOneField', [],
			{'to': u"orm['friends.JoinInvitation']", 'unique': 'True',
			 'primary_key': 'True'})
		},
		...
		u'friends.contact': {
			...
			'user': ('django.db.models.fields.related.ForeignKey', [],
					 {'related_name': "'contacts'", 'to': u"orm['auth.User']"}),
