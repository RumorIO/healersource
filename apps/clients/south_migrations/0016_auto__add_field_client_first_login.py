...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.first_login'
        db.add_column('clients_client', 'first_login', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.first_login'
        db.delete_column('clients_client', 'first_login')
