...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.ghp_notification_frequency'
        db.add_column(u'clients_client', 'ghp_notification_frequency',
                      self.gf('django.db.models.fields.CharField')(default='every time', max_length=32),
                      keep_default=False)

        # Adding field 'Client.ghp_notification_last_sent_date'
        db.add_column(u'clients_client', 'ghp_notification_last_sent_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.ghp_notification_frequency'
        db.delete_column(u'clients_client', 'ghp_notification_frequency')

        # Deleting field 'Client.ghp_notification_last_sent_date'
        db.delete_column(u'clients_client', 'ghp_notification_last_sent_date')
    ...
    models = {
        ...
        u'clients.client': {
            ...
            'ghp_notification_last_sent_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
