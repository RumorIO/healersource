...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.referred_by'
        db.add_column('clients_client', 'referred_by', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.referred_by'
        db.delete_column('clients_client', 'referred_by')
