...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('clients_client', 'website', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Client.facebook'
        db.add_column('clients_client', 'facebook', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Client.twitter'
        db.add_column('clients_client', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Client.google_plus'
        db.add_column('clients_client', 'google_plus', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Client.linkedin'
        db.add_column('clients_client', 'linkedin', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.website'
        db.delete_column('clients_client', 'website')

        # Deleting field 'Client.facebook'
        db.delete_column('clients_client', 'facebook')

        # Deleting field 'Client.twitter'
        db.delete_column('clients_client', 'twitter')

        # Deleting field 'Client.google_plus'
        db.delete_column('clients_client', 'google_plus')

        # Deleting field 'Client.linkedin'
        db.delete_column('clients_client', 'linkedin')
