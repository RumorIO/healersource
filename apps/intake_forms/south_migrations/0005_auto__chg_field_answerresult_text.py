...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerResult.text'
        db.alter_column(u'intake_forms_answerresult', 'text', self.gf('encrypted_fields.fields.EncryptedTextField')())

    def backwards(self, orm):

        # Changing field 'AnswerResult.text'
        db.alter_column(u'intake_forms_answerresult', 'text', self.gf('django.db.models.fields.TextField')())
