...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntakeForm.created_at'
        db.add_column(u'intake_forms_intakeform', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 20, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Answer.date'
        db.alter_column(u'intake_forms_answer', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'IntakeForm.created_at'
        db.delete_column(u'intake_forms_intakeform', 'created_at')


        # Changing field 'Answer.date'
        db.alter_column(u'intake_forms_answer', 'date', self.gf('django.db.models.fields.DateTimeField')())
