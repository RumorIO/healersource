...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntakeFormSentHistory'
        db.create_table(u'intake_forms_intakeformsenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='intake_form_sent_history_client', to=orm['clients.Client'])),
            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='intake_form_sent_history_healer', to=orm['healers.Healer'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'intake_forms', ['IntakeFormSentHistory'])


    def backwards(self, orm):
        # Deleting model 'IntakeFormSentHistory'
        db.delete_table(u'intake_forms_intakeformsenthistory')
