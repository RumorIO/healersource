...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MessageExtra'
        db.create_table(u'messages_hs_messageextra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_messages.Message'], unique=True)),
            ('source', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'messages_hs', ['MessageExtra'])


    def backwards(self, orm):
        # Deleting model 'MessageExtra'
        db.delete_table(u'messages_hs_messageextra')
    ...
    models = {
        ...
        u'messages_hs.messageextra': {
            'Meta': {'object_name': 'MessageExtra'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_messages.Message']", 'unique': 'True'}),
