...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactSocialId.point'
        db.add_column(u'contacts_hs_contactsocialid', 'point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactSocialId.point'
        db.delete_column(u'contacts_hs_contactsocialid', 'point')
    ...
    models = {
        ...
        u'contacts_hs.contactemail': {
            'Meta': {'object_name': 'ContactEmail'},
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emails'", 'to': u"orm['contacts_hs.ContactInfo']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '42'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'Other'", 'max_length': '42'})
        },
        u'contacts_hs.contactgroup': {
            'Meta': {'object_name': 'ContactGroup'},
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'groups'", 'symmetrical': 'False', 'to': u"orm['contacts_hs.ContactInfo']"}),
            'google_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'contacts_hs.contactinfo': {
            'Meta': {'object_name': 'ContactInfo'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clients.Client']", 'null': 'True', 'blank': 'True'}),
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['friends.Contact']", 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'healer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'healer_contacts'", 'to': u"orm['healers.Healer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'})
        },
        u'contacts_hs.contactphone': {
            'Meta': {'object_name': 'ContactPhone'},
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'phone_numbers'", 'to': u"orm['contacts_hs.ContactInfo']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'contacts_hs.contactsimportstatus': {
