...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_hs_contactphone', (
        ...
        db.send_create_signal('contacts_hs', ['ContactPhone'])

        # Adding field 'ContactGroup.google_id'
        db.add_column('contacts_hs_contactgroup', 'google_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('contacts_hs_contactphone')

        # Deleting field 'ContactGroup.google_id'
        db.delete_column('contacts_hs_contactgroup', 'google_id')
