...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContactsImportStatus'
        db.create_table('contacts_hs_contactsimportstatus', (
            ...
            ('contacts_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('contacts_hs', ['ContactsImportStatus'])


    def backwards(self, orm):
        
        # Deleting model 'ContactsImportStatus'
        db.delete_table('contacts_hs_contactsimportstatus')
