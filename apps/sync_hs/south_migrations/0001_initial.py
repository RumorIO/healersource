...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CalendarSyncStatus'
        db.create_table('sync_hs_calendarsyncstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('api', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('sync_hs', ['CalendarSyncStatus'])

        # Adding model 'CalendarSyncQueueTask'
        db.create_table('sync_hs_calendarsyncqueuetask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Appointment'])),
            ('api', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ...
        db.send_create_signal('sync_hs', ['CalendarSyncQueueTask'])


    def backwards(self, orm):
        
        # Deleting model 'CalendarSyncStatus'
        db.delete_table('sync_hs_calendarsyncstatus')

        # Deleting model 'CalendarSyncQueueTask'
        db.delete_table('sync_hs_calendarsyncqueuetask')
    ...
    models = {
        ...
        'sync_hs.calendarsyncqueuetask': {
            'Meta': {'object_name': 'CalendarSyncQueueTask'},
            'action': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'api': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['healers.Appointment']"}),
            'attempts': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
        'sync_hs.calendarsyncstatus': {
            'Meta': {'object_name': 'CalendarSyncStatus'},
            'api': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
