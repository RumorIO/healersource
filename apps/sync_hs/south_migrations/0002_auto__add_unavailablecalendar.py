...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnavailableCalendar'
        db.create_table('sync_hs_unavailablecalendar', (
            ...
            ('feed_link', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ...
        db.send_create_signal('sync_hs', ['UnavailableCalendar'])


    def backwards(self, orm):
        
        # Deleting model 'UnavailableCalendar'
        db.delete_table('sync_hs_unavailablecalendar')
