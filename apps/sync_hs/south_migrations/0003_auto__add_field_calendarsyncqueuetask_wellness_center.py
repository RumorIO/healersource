...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalendarSyncQueueTask.wellness_center'
        db.add_column(u'sync_hs_calendarsyncqueuetask', 'wellness_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['healers.WellnessCenter'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalendarSyncQueueTask.wellness_center'
        db.delete_column(u'sync_hs_calendarsyncqueuetask', 'wellness_center_id')
    ...
    models = {
        ...
        u'sync_hs.calendarsyncqueuetask': {
            'Meta': {'ordering': "['id']", 'object_name': 'CalendarSyncQueueTask'},
            'action': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'api': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['healers.Appointment']"}),
            'attempts': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'wellness_center': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['healers.WellnessCenter']", 'null': 'True'})
        },
        u'sync_hs.calendarsyncstatus': {
