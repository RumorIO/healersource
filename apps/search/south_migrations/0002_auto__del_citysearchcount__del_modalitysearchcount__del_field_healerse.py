...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HealerSearchHistory.city'
        db.delete_column(u'search_healersearchhistory', 'city')

        # Adding field 'HealerSearchHistory.zipcode'
        db.add_column(u'search_healersearchhistory', 'zipcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Zipcode'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'HealerSearchHistory.city'
        db.add_column(u'search_healersearchhistory', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HealerSearchHistory.zipcode'
        db.delete_column(u'search_healersearchhistory', 'zipcode_id')
    ...
    models = {
        ...
        u'search.healersearchhistory': {
            ...
            'zipcode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['healers.Zipcode']", 'null': 'True', 'blank': 'True'})
        }
    }
