...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['stripe_id']
        db.delete_unique(u'payments_payment', ['stripe_id'])


        # Changing field 'Payment.stripe_id'
        db.alter_column(u'payments_payment', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.stripe_id'
        raise RuntimeError("Cannot reverse this migration. 'Payment.stripe_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Payment.stripe_id'
        db.alter_column(u'payments_payment', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
        # Adding unique constraint on 'Payment', fields ['stripe_id']
        db.create_unique(u'payments_payment', ['stripe_id'])
    ...
    models = {
        ...
        u'healers.healer': {
            ...
            'deposit_percentage': ('django.db.models.fields.PositiveIntegerField', [], {'default': '100'}),
            ...
            'notes_notice_shown': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'healers.treatmenttypelength': {
            'Meta': {'ordering': "['length', 'cost']", 'object_name': 'TreatmentTypeLength'},
        ...
        u'healers.wellnesscenter': {
            ...
            'clients_visible_to_providers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'payments.currentsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'notes_status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'schedule_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'payments.customer': {
            ...
            'card_kind': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'card_last_4': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'card_stripe_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_purged': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment_notes': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'payment_schedule': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'stripe_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
        ...
        u'payments.payment': {
            ...
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments'", 'to': u"orm['healers.Appointment']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
