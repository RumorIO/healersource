...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.stripe_id'
        db.add_column(u'payments_payment', 'stripe_id',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255),
                      keep_default=False)

        # Adding field 'Payment.created_at'
        db.add_column(u'payments_payment', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Payment.paid'
        db.add_column(u'payments_payment', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.stripe_id'
        db.delete_column(u'payments_payment', 'stripe_id')

        # Deleting field 'Payment.created_at'
        db.delete_column(u'payments_payment', 'created_at')

        # Deleting field 'Payment.paid'
        db.delete_column(u'payments_payment', 'paid')
