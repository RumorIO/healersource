...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CurrentSubscription.schedule_active'
        db.add_column(u'payments_currentsubscription', 'schedule_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CurrentSubscription.schedule_active'
        db.delete_column(u'payments_currentsubscription', 'schedule_active')
    ...
    models = {
        ...
        u'payments.currentsubscription': {
            ...
            'schedule_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
        u'payments.customer': {
