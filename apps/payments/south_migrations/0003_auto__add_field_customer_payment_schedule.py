...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.payment_schedule'
        db.add_column(u'payments_customer', 'payment_schedule',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.payment_schedule'
        db.delete_column(u'payments_customer', 'payment_schedule')
