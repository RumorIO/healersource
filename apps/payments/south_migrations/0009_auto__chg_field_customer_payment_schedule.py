...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.payment_schedule'
        db.alter_column(u'payments_customer', 'payment_schedule', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Customer.payment_schedule'
        db.alter_column(u'payments_customer', 'payment_schedule', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
