...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'payments_payment', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Payment.amount'
        raise RuntimeError("Cannot reverse this migration. 'Payment.amount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Payment.amount'
        db.alter_column(u'payments_payment', 'amount', self.gf('django.db.models.fields.FloatField')())
