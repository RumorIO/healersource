...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Modality.rejected'
        db.add_column(u'modality_modality', 'rejected',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding index on 'Modality', fields ['approved']
        db.create_index(u'modality_modality', ['approved'])

        # Adding index on 'Modality', fields ['visible']
        db.create_index(u'modality_modality', ['visible'])


    def backwards(self, orm):
        # Removing index on 'Modality', fields ['visible']
        db.delete_index(u'modality_modality', ['visible'])

        # Removing index on 'Modality', fields ['approved']
        db.delete_index(u'modality_modality', ['approved'])

        # Deleting field 'Modality.rejected'
        db.delete_column(u'modality_modality', 'rejected')
