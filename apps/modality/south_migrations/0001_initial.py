...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ModalityCategory'
        db.create_table('modality_modalitycategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
        ))
        db.send_create_signal('modality', ['ModalityCategory'])

        # Adding model 'Modality'
        db.create_table('modality_modality', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('modality', ['Modality'])

        # Adding M2M table for field category on 'Modality'
        db.create_table('modality_modality_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('modality', models.ForeignKey(orm['modality.modality'], null=False)),
            ('modalitycategory', models.ForeignKey(orm['modality.modalitycategory'], null=False))
        ))
        db.create_unique('modality_modality_category', ['modality_id', 'modalitycategory_id'])

        # Adding M2M table for field healer on 'Modality'
        db.create_table('modality_modality_healer', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('modality', models.ForeignKey(orm['modality.modality'], null=False)),
            ('healer', models.ForeignKey(orm['healers.healer'], null=False))
        ))
        db.create_unique('modality_modality_healer', ['modality_id', 'healer_id'])


    def backwards(self, orm):
        
        # Deleting model 'ModalityCategory'
        db.delete_table('modality_modalitycategory')

        # Deleting model 'Modality'
        db.delete_table('modality_modality')

        # Removing M2M table for field category on 'Modality'
        db.delete_table('modality_modality_category')

        # Removing M2M table for field healer on 'Modality'
        db.delete_table('modality_modality_healer')
