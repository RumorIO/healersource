...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HealerActions.special'
        db.delete_column(u'dashboard_healeractions', 'special')
    ...
    def backwards(self, orm):
        # Adding field 'HealerActions.special'
        db.add_column(u'dashboard_healeractions', 'special',
