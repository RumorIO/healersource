...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('dashboard_healeractions', 'object_pk', 'object_id')

    def backwards(self, orm):
        db.rename_column('dashboard_healeractions', 'object_id', 'object_pk')
    ...
    models = {
        ...
        u'dashboard.healeractions': {
            'Meta': {'unique_together': "(['action', 'content_type', 'object_id'],)", 'object_name': 'HealerActions'},
