...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HealerMails.special'
        db.delete_column(u'dashboard_healermails', 'special')

        # Adding field 'HealerMails.process'
        db.add_column(u'dashboard_healermails', 'process',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HealerMails.special'
        db.add_column(u'dashboard_healermails', 'special',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=254, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'HealerMails.process'
        db.delete_column(u'dashboard_healermails', 'process')
    ...
    models = {
        ...
        u'dashboard.healermails': {
            ...
            'process': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '254', 'null': 'True', 'blank': 'True'}),
