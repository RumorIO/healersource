...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HealerMails.process'
        db.alter_column(u'dashboard_healermails', 'process', self.gf('django.db.models.fields.CharField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'HealerMails.process'
        db.alter_column(u'dashboard_healermails', 'process', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))
