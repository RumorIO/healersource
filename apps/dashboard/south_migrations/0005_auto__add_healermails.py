...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HealerMails'
        db.create_table(u'dashboard_healermails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('delay', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('once', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal(u'dashboard', ['HealerMails'])


    def backwards(self, orm):
        # Deleting model 'HealerMails'
        db.delete_table(u'dashboard_healermails')
