...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.send_notification'
        db.add_column('healers_healer', 'send_notification', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.send_notification'
        db.delete_column('healers_healer', 'send_notification')
    ...
    models = {
        ...
        'healers.healer': {
            ...
            'send_update_notification': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
