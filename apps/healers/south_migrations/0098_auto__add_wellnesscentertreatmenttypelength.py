...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WellnessCenterTreatmentTypeLength'
        db.create_table(u'healers_wellnesscentertreatmenttypelength', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wellness_center_treatment_type_lengths', to=orm['healers.Healer'])),
            ('wellness_center', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.WellnessCenter'])),
        ))
        db.send_create_signal(u'healers', ['WellnessCenterTreatmentTypeLength'])

        # Adding M2M table for field treatment_type_lengths on 'WellnessCenterTreatmentTypeLength'
        db.create_table(u'healers_wellnesscentertreatmenttypelength_treatment_type_le21c0', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wellnesscentertreatmenttypelength', models.ForeignKey(orm[u'healers.wellnesscentertreatmenttypelength'], null=False)),
            ('treatmenttypelength', models.ForeignKey(orm[u'healers.treatmenttypelength'], null=False))
        ))
        db.create_unique(u'healers_wellnesscentertreatmenttypelength_treatment_type_le21c0', ['wellnesscentertreatmenttypelength_id', 'treatmenttypelength_id'])


    def backwards(self, orm):
        # Deleting model 'WellnessCenterTreatmentTypeLength'
        db.delete_table(u'healers_wellnesscentertreatmenttypelength')

        # Removing M2M table for field treatment_type_lengths on 'WellnessCenterTreatmentTypeLength'
        db.delete_table('healers_wellnesscentertreatmenttypelength_treatment_type_le21c0')
    ...
    models = {
        ...
        u'healers.wellnesscentertreatmenttypelength': {
            'Meta': {'object_name': 'WellnessCenterTreatmentTypeLength'},
            'healer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wellness_center_treatment_type_lengths'", 'to': u"orm['healers.Healer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'treatment_type_lengths': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['healers.TreatmentTypeLength']", 'null': 'True', 'blank': 'True'}),
            'wellness_center': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['healers.WellnessCenter']"})
        },
        u'healers.zipcode': {
