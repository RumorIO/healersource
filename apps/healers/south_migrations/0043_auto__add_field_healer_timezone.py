...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.timezone'
        db.add_column('healers_healer', 'timezone', self.gf('django.db.models.fields.CharField')(default='', max_length='6', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.timezone'
        db.delete_column('healers_healer', 'timezone')
