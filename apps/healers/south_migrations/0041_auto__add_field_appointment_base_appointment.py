...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_appointment', 'base_appointment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['healers.Appointment'], null=True), keep_default=False)
