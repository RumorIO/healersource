...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.review_permission'
        db.add_column('healers_healer', 'review_permission', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.review_permission'
        db.delete_column('healers_healer', 'review_permission')
