...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.confirmed'
        db.add_column('healers_appointment', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Appointment.confirmed'
        db.delete_column('healers_appointment', 'confirmed')
