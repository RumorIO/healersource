...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_location', 'timezone', self.gf('django.db.models.fields.CharField')(default='', max_length='6', blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Location.timezone'
        db.delete_column('healers_location', 'timezone')
