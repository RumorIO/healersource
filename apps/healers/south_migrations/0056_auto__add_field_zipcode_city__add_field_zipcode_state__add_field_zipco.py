...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_zipcode', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Zipcode.state'
        db.add_column('healers_zipcode', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)

        # Adding field 'Zipcode.population'
        db.add_column('healers_zipcode', 'population', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Zipcode.city'
        db.delete_column('healers_zipcode', 'city')

        # Deleting field 'Zipcode.state'
        db.delete_column('healers_zipcode', 'state')

        # Deleting field 'Zipcode.population'
        db.delete_column('healers_zipcode', 'population')
