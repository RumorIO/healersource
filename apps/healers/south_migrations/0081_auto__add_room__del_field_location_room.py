...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Room'
        db.create_table(u'healers_room', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Location'])),
        ))
        db.send_create_signal(u'healers', ['Room'])

        # Deleting field 'Location.room'
        db.delete_column(u'healers_location', 'room')


    def backwards(self, orm):
        # Deleting model 'Room'
        db.delete_table(u'healers_room')

        # Adding field 'Location.room'
        db.add_column(u'healers_location', 'room',
