...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            # Adding field 'Appointment.repeat_period'
            db.add_column('healers_appointment', 'repeat_period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True), keep_default=False)

            # Adding field 'Appointment.repeat_every'
            db.add_column('healers_appointment', 'repeat_every', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True), keep_default=False)

            # Adding field 'Appointment.repeat_end_after'
            db.add_column('healers_appointment', 'repeat_end_after', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True), keep_default=False)

            # Adding field 'Appointment.base_appointment'
            db.add_column('healers_appointment', 'base_appointment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Appointment'], null=True, blank=True), keep_default=False)
        except Exception:
            pass
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appointment.repeat_period'
        db.delete_column('healers_appointment', 'repeat_period')

        # Deleting field 'Appointment.repeat_every'
        db.delete_column('healers_appointment', 'repeat_every')

        # Deleting field 'Appointment.repeat_end_after'
        db.delete_column('healers_appointment', 'repeat_end_after')

        # Deleting field 'Appointment.base_appointment'
        db.delete_column('healers_appointment', 'base_appointment_id')
    ...
    models = {
        ...
        'healers.appointment': {
            ...
            'repeat_end_after': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'repeat_every': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
