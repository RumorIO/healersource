...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.google_email'
        db.add_column('healers_healer', 'google_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.google_email'
        db.delete_column('healers_healer', 'google_email')
