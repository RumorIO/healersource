...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column 'WellnessCenter.payment_setting' to 'WellnessCenter.payment_schedule_setting'
        db.rename_column(u'healers_wellnesscenter', 'payment_setting', 'payment_schedule_setting')

        # Renaming column 'Healer.payment' to 'Healer.payment_schedule'
        db.rename_column(u'healers_healer', 'payment', 'payment_schedule')

    def backwards(self, orm):
        # Renaming column 'WellnessCenter.payment_schedule_setting' to 'WellnessCenter.payment_setting'
        db.rename_column(u'healers_wellnesscenter', 'payment_schedule_setting', 'payment_setting')

        # Renaming column 'Healer.payment_schedule' to 'Healer.payment'
        db.rename_column(u'healers_healer', 'payment_schedule', 'payment')

        # Deleting field 'WellnessCenter.payment_schedule_setting'
        db.delete_column(u'healers_wellnesscenter', 'payment_schedule_setting')

        # Adding field 'Healer.payment'
        db.add_column(u'healers_healer', 'payment',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Healer.payment_schedule'
        db.delete_column(u'healers_healer', 'payment_schedule')
    ...
    models = {
        ...
        u'healers.healer': {
            ...
            'payment_schedule': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
