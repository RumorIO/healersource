...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_location', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=42, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.title'
        db.delete_column('healers_location', 'title')
