...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Healer.google_calendar_link'
        db.delete_column('healers_healer', 'google_calendar_link')

        # Adding field 'Healer.google_calendar_feed_link'
        db.add_column('healers_healer', 'google_calendar_feed_link', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)

        # Adding field 'Healer.google_calendar_edit_link'
        db.add_column('healers_healer', 'google_calendar_edit_link', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Healer.google_calendar_link'
        db.add_column('healers_healer', 'google_calendar_link', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)

        # Deleting field 'Healer.google_calendar_feed_link'
        db.delete_column('healers_healer', 'google_calendar_feed_link')

        # Deleting field 'Healer.google_calendar_edit_link'
        db.delete_column('healers_healer', 'google_calendar_edit_link')
