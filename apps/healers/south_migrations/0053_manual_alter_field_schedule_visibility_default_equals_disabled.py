...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('healers_healer', 'scheduleVisibility', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3))


    def backwards(self, orm):
        
        # Deleting field 'Healer.office_hours_start'
        db.alter_column('healers_healer', 'scheduleVisibility', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))
