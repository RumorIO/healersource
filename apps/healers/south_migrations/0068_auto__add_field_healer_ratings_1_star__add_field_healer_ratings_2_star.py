...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.ratings_1_star'
        db.add_column('healers_healer', 'ratings_1_star', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.ratings_2_star'
        db.add_column('healers_healer', 'ratings_2_star', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.ratings_3_star'
        db.add_column('healers_healer', 'ratings_3_star', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.ratings_4_star'
        db.add_column('healers_healer', 'ratings_4_star', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.ratings_5_star'
        db.add_column('healers_healer', 'ratings_5_star', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.ratings_average'
        db.add_column('healers_healer', 'ratings_average', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.ratings_1_star'
        db.delete_column('healers_healer', 'ratings_1_star')

        # Deleting field 'Healer.ratings_2_star'
        db.delete_column('healers_healer', 'ratings_2_star')

        # Deleting field 'Healer.ratings_3_star'
        db.delete_column('healers_healer', 'ratings_3_star')

        # Deleting field 'Healer.ratings_4_star'
        db.delete_column('healers_healer', 'ratings_4_star')

        # Deleting field 'Healer.ratings_5_star'
        db.delete_column('healers_healer', 'ratings_5_star')

        # Deleting field 'Healer.ratings_average'
        db.delete_column('healers_healer', 'ratings_average')
