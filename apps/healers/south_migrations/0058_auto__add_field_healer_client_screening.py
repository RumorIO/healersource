...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.client_screening'
        db.add_column('healers_healer', 'client_screening', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.client_screening'
        db.delete_column('healers_healer', 'client_screening')
