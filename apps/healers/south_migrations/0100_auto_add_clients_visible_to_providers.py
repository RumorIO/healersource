...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenter.clients_visible_to_providers'
        db.add_column(u'healers_wellnesscenter', 'clients_visible_to_providers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'WellnessCenter.clients_visible_to_providers'
        db.delete_column(u'healers_wellnesscenter', 'clients_visible_to_providers')
