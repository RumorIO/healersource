...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_address', 'address_line1', self.gf('django.db.models.fields.CharField')(default='', max_length=42, blank=True), keep_default=False)
        ...
        db.add_column('healers_address', 'postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)

        # Adding field 'Address.city'
        db.add_column('healers_address', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=42, blank=True), keep_default=False)
...
#  DGL - HAND EDITED      db.create_unique('healers_address', ['address_line2', 'city', 'address_line1', 'state_province', 'postal_code', 'country'])
