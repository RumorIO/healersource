...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenter.schedule_side_by_side_setting'
        db.add_column(u'healers_wellnesscenter', 'schedule_side_by_side_setting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WellnessCenter.schedule_side_by_side_setting'
        db.delete_column(u'healers_wellnesscenter', 'schedule_side_by_side_setting')
