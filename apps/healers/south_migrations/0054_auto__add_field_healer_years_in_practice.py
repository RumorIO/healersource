...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.years_in_practice'
        db.add_column('healers_healer', 'years_in_practice', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.years_in_practice'
        db.delete_column('healers_healer', 'years_in_practice')
