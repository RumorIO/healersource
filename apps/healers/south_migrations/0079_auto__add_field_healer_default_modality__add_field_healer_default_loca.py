...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.default_modality'
        db.add_column(u'healers_healer', 'default_modality',
                      self.gf('django.db.models.fields.CharField')(default='Healer', max_length=64),
                      keep_default=False)

        # Adding field 'Healer.default_location'
        db.add_column(u'healers_healer', 'default_location',
                      self.gf('django.db.models.fields.CharField')(default='USA', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.default_modality'
        db.delete_column(u'healers_healer', 'default_modality')

        # Deleting field 'Healer.default_location'
        db.delete_column(u'healers_healer', 'default_location')
