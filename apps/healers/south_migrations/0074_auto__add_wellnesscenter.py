...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WellnessCenter'
        db.create_table('healers_wellnesscenter', (
            ('healer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['healers.Healer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('healers', ['WellnessCenter'])


    def backwards(self, orm):
        
        # Deleting model 'WellnessCenter'
        db.delete_table('healers_wellnesscenter')
