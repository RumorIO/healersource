...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Referrals'
        db.create_table('healers_referrals', (
            ('friendship_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['friends.Friendship'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('healers', ['Referrals'])

        # Adding model 'Clients'
        db.create_table('healers_clients', (
            ('friendship_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['friends.Friendship'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('healers', ['Clients'])


    def backwards(self, orm):
        
        # Deleting model 'Referrals'
        db.delete_table('healers_referrals')

        # Deleting model 'Clients'
        db.delete_table('healers_clients')
