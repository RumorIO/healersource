...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.location_bar_title'
        db.add_column('healers_healer', 'location_bar_title', self.gf('django.db.models.fields.CharField')(default='Location: ', max_length=36, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Healer.location_bar_title'
        db.delete_column('healers_healer', 'location_bar_title')
