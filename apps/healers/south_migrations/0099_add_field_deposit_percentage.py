...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.deposit_percentage'
        db.add_column(u'healers_healer', 'deposit_percentage',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.deposit_percentage'
        db.delete_column(u'healers_healer', 'deposit_percentage')
