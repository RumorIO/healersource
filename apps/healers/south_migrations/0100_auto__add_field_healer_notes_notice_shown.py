...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.notes_notice_shown'
        db.add_column(u'healers_healer', 'notes_notice_shown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.notes_notice_shown'
        db.delete_column(u'healers_healer', 'notes_notice_shown')
