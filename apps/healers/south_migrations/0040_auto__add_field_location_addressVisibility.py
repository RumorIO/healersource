...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.addressVisibility'
        db.add_column('healers_location', 'addressVisibility', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.addressVisibility'
        db.delete_column('healers_location', 'addressVisibility')
