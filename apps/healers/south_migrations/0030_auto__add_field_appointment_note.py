...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.note'
        db.add_column('healers_appointment', 'note', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Appointment.note'
        db.delete_column('healers_appointment', 'note')
