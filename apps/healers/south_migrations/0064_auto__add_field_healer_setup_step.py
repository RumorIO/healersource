...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.setup_step'
        db.add_column('healers_healer', 'setup_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.setup_step'
        db.delete_column('healers_healer', 'setup_step')
