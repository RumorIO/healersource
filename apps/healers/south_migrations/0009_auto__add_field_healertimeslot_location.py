...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HealerTimeslot.location'
        db.add_column('healers_healertimeslot', 'location', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['healers.Location'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HealerTimeslot.location'
        db.delete_column('healers_healertimeslot', 'location_id')
