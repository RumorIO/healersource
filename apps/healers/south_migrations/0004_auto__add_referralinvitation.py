...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReferralInvitation'
        db.create_table('healers_referralinvitation', (
            ('friendshipinvitation_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['friends.FriendshipInvitation'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('healers', ['ReferralInvitation'])


    def backwards(self, orm):
        
        # Deleting model 'ReferralInvitation'
        db.delete_table('healers_referralinvitation')
