...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Healer.payment'
	for healer in orm.Healer.objects.all():
		healer.payment = 0
		healer.save()
        db.alter_column(u'healers_healer', 'payment', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Healer.payment'
        db.alter_column(u'healers_healer', 'payment', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'healers.healer': {
            ...
            'payment': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
        ...
        u'healers.wellnesscenter': {
            ...
            'payment_setting': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'})
        },
