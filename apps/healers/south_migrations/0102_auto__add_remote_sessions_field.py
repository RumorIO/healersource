...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.remote_sessions'
        db.add_column(u'healers_healer', 'remote_sessions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.remote_sessions'
        db.delete_column(u'healers_healer', 'remote_sessions')
    ...
    models = {
        ...
        u'clients.client': {
            ...
            'ghp_notification_frequency': ('django.db.models.fields.CharField', [], {'default': "'every time'", 'max_length': '32'}),
        ...
        u'healers.concierge': {
            'Meta': {'object_name': 'Concierge', '_ormbases': [u'healers.Healer']},
        ...
        u'healers.healer': {
            ...
            'remote_sessions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
