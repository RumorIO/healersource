...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.scheduleVisibility'
        db.add_column('healers_healer', 'scheduleVisibility', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Healer.profileVisibility'
        db.add_column('healers_healer', 'profileVisibility', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Changing field 'Healer.manualAppointmentConfirmation'
        db.alter_column('healers_healer', 'manualAppointmentConfirmation', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Location.room'
        db.alter_column('healers_location', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Room'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Healer.scheduleVisibility'
        db.delete_column('healers_healer', 'scheduleVisibility')

        # Deleting field 'Healer.profileVisibility'
        db.delete_column('healers_healer', 'profileVisibility')

        # Changing field 'Healer.manualAppointmentConfirmation'
        db.alter_column('healers_healer', 'manualAppointmentConfirmation', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Location.room'
        db.alter_column('healers_location', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['healers.Room']))
