...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.additional_text_for_email'
        db.add_column('healers_healer', 'additional_text_for_email', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.additional_text_for_email'
        db.delete_column('healers_healer', 'additional_text_for_email')
