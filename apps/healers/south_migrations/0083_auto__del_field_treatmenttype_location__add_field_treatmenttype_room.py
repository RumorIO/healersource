...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TreatmentType.location'
        db.delete_column(u'healers_treatmenttype', 'location_id')
    ...
    def backwards(self, orm):
        # Adding field 'TreatmentType.location'
        db.add_column(u'healers_treatmenttype', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='treatment_types', null=True, to=orm['healers.Location']),
                      keep_default=False)
    ...
    models = {
        ...
        u'healers.treatmenttype': {
            ...
            'is_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'treatment_types'", 'null': 'True', 'to': u"orm['healers.Room']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '42'})
        },
