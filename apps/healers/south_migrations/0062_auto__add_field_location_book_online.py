...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.book_online'
        db.add_column('healers_location', 'book_online', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.book_online'
        db.delete_column('healers_location', 'book_online')
