...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.display_address'
        db.add_column('healers_location', 'display_address', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.display_address'
        db.delete_column('healers_location', 'display_address')
    ...
    models = {
        ...
        'healers.location': {
            ...
            'display_address': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
