...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Deleting field 'Healer.smart_scheduler_avoid_gaps'
#		db.delete_column('healers_healer', 'smart_scheduler_avoid_gaps')

		# Adding field 'Healer.smart_scheduler_avoid_gaps_num'
		db.add_column('healers_healer', 'smart_scheduler_avoid_gaps_num', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


	def backwards(self, orm):

		# Adding field 'Healer.smart_scheduler_avoid_gaps'
		db.add_column('healers_healer', 'smart_scheduler_avoid_gaps', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

		# Deleting field 'Healer.smart_scheduler_avoid_gaps_num'
		db.delete_column('healers_healer', 'smart_scheduler_avoid_gaps_num')
