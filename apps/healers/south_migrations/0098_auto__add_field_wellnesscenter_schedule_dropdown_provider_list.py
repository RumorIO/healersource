...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenter.schedule_dropdown_provider_list'
        db.add_column(u'healers_wellnesscenter', 'schedule_dropdown_provider_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WellnessCenter.schedule_dropdown_provider_list'
        db.delete_column(u'healers_wellnesscenter', 'schedule_dropdown_provider_list')
