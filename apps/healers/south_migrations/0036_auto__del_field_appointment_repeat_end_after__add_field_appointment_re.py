...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.repeat_count'
        db.add_column('healers_appointment', 'repeat_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appointment.repeat_count'
        db.delete_column('healers_appointment', 'repeat_count')
