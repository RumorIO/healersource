...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HealerLocation'
        db.create_table('healers_healerlocation', (
        ...
        db.send_create_signal('healers', ['HealerLocation'])

        # Adding model 'Address'
        db.create_table('healers_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address_line1', self.gf('django.db.models.fields.CharField')(max_length=42)),
            ('address_line2', self.gf('django.db.models.fields.CharField')(max_length=42, blank=True)),
            ('postal_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=42)),
            ('state_province', self.gf('django.db.models.fields.CharField')(max_length=42, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=42, blank=True)),
        ))
        db.send_create_signal('healers', ['Address'])

        # Adding unique constraint on 'Address', fields ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country']
        db.create_unique('healers_address', ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country'])

        # Adding model 'Room'
        db.create_table('healers_room', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal('healers', ['Room'])

        # Adding model 'Location'
        db.create_table('healers_location', (
            ('address_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['healers.Address'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=42)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Room'], blank=True)),
        ))
        db.send_create_signal('healers', ['Location'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Address', fields ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country']
        db.delete_unique('healers_address', ['address_line1', 'address_line2', 'postal_code', 'city', 'state_province', 'country'])

        # Deleting model 'HealerLocation'
        db.delete_table('healers_healerlocation')

        # Deleting model 'Address'
        db.delete_table('healers_address')

        # Deleting model 'Room'
        db.delete_table('healers_room')

        # Deleting model 'Location'
        db.delete_table('healers_location')
