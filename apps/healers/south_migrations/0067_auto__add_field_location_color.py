...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.color'
        db.add_column('healers_location', 'color', self.gf('django.db.models.fields.CharField')(default='', max_length=7), keep_default=False)

        db.start_transaction()
        for c in Client.objects.all():
            i = 0
            for l in ClientLocation.objects.filter(client=c).order_by('-location__is_default'):
                l.location.color = Location.get_next_color(i)
                l.location.save()
                i += 1
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Location.color'
        db.delete_column('healers_location', 'color')
