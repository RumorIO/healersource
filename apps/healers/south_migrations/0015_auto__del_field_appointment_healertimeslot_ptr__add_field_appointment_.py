...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.id'
        try:
            db.add_column('healers_appointment', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
        except Exception:
            #sqlite
            db.add_column('healers_appointment', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True, default=0))

        # Adding field 'Appointment.start'
        db.add_column('healers_appointment', 'start', self.gf('django.db.models.fields.DateTimeField')(default='1969-08-17'), keep_default=False)

        # Adding field 'Appointment.end'
        db.add_column('healers_appointment', 'end', self.gf('django.db.models.fields.DateTimeField')(default='1969-08-17'), keep_default=False)
        ...
        # Adding field 'Appointment.healer'
        db.add_column('healers_appointment', 'healer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='healer_appointments', to=orm['healers.Healer']), keep_default=False)
