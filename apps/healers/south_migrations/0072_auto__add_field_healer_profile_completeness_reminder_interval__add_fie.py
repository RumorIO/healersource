...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.profile_completeness_reminder_interval'
        db.add_column(u'healers_healer', 'profile_completeness_reminder_interval',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Healer.profile_completeness_reminder_lastdate'
        db.add_column(u'healers_healer', 'profile_completeness_reminder_lastdate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.profile_completeness_reminder_interval'
        db.delete_column(u'healers_healer', 'profile_completeness_reminder_interval')

        # Deleting field 'Healer.profile_completeness_reminder_lastdate'
        db.delete_column(u'healers_healer', 'profile_completeness_reminder_lastdate')
