...
from healers.models import Healer, TreatmentType, Appointment
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('healers_treatmenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='healer_treatment_types', to=orm['healers.Healer'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=24)),
...
#            ('cost', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('healers', ['TreatmentType'])

        # Deleting field 'Healer.beta_tester'
        db.delete_column('healers_healer', 'beta_tester')

        # Adding field 'Healer.setup_time'
        db.add_column('healers_healer', 'setup_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=30), keep_default=False)

        # Adding field 'Appointment.treatment_type'
#        for healer in Healer.objects.all():
#                TreatmentType.objects.create(healer=healer, title='Default')
        db.add_column('healers_appointment', 'treatment_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['healers.TreatmentType']), keep_default=False)
#        db.start_transaction()
#        for treatment in TreatmentType.objects.values('id', 'healer').all():
#            Appointment.objects.filter(healer=treatment['healer']).update(treatment_type=treatment['id'])
#        db.commit_transaction()

    def backwards(self, orm):
        
        # Deleting model 'TreatmentType'
        db.delete_table('healers_treatmenttype')

        # Deleting field 'Appointment.treatment_type'
        db.delete_column('healers_appointment', 'treatment_type_id')

        # Adding field 'Healer.beta_tester'
        db.add_column('healers_healer', 'beta_tester', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Healer.setup_time'
        db.delete_column('healers_healer', 'setup_time')
