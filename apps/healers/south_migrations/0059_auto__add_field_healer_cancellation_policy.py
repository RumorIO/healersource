...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.cancellation_policy'
        db.add_column('healers_healer', 'cancellation_policy', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.cancellation_policy'
        db.delete_column('healers_healer', 'cancellation_policy')
