...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WellnessCenter.schedule_full_width'
        db.delete_column(u'healers_wellnesscenter', 'schedule_full_width')

        # Adding field 'Healer.schedule_full_width'
        db.add_column(u'healers_healer', 'schedule_full_width',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WellnessCenter.schedule_full_width'
        db.add_column(u'healers_wellnesscenter', 'schedule_full_width',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Healer.schedule_full_width'
        db.delete_column(u'healers_healer', 'schedule_full_width')
