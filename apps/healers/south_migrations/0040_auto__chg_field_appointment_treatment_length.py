...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointment.treatment_length'
        db.alter_column('healers_appointment', 'treatment_length_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.TreatmentTypeLength'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Appointment.treatment_length'
        db.alter_column('healers_appointment', 'treatment_length_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['healers.TreatmentTypeLength']))
