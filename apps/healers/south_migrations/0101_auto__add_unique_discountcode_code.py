...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DiscountCode', fields ['code']
        db.create_unique(u'healers_discountcode', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'DiscountCode', fields ['code']
        db.delete_unique(u'healers_discountcode', ['code'])
