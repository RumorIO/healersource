...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.office_hours_start'
        db.add_column('healers_healer', 'office_hours_start', self.gf('django.db.models.fields.TimeField')(default='10:00:00'), keep_default=False)

        # Adding field 'Healer.office_hours_end'
        db.add_column('healers_healer', 'office_hours_end', self.gf('django.db.models.fields.TimeField')(default='20:00:00'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.office_hours_start'
        db.delete_column('healers_healer', 'office_hours_start')

        # Deleting field 'Healer.office_hours_end'
        db.delete_column('healers_healer', 'office_hours_end')
