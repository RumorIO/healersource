...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenter.schedule_trial_started_date'
        db.add_column(u'healers_wellnesscenter', 'schedule_trial_started_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WellnessCenter.schedule_trial_started_date'
        db.delete_column(u'healers_wellnesscenter', 'schedule_trial_started_date')
