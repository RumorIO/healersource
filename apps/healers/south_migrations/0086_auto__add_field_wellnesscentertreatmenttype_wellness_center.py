...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenterTreatmentType.wellness_center'
        db.add_column(u'healers_wellnesscentertreatmenttype', 'wellness_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['healers.WellnessCenter']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WellnessCenterTreatmentType.wellness_center'
        db.delete_column(u'healers_wellnesscentertreatmenttype', 'wellness_center_id')
