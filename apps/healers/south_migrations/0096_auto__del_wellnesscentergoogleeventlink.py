...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WellnessCenterGoogleEventLink'
        db.delete_table(u'healers_wellnesscentergoogleeventlink')


    def backwards(self, orm):
        # Adding model 'WellnessCenterGoogleEventLink'
        db.create_table(u'healers_wellnesscentergoogleeventlink', (
            ('wellness_center', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.WellnessCenter'])),
            ('google_event_link', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wellness_center_google_event_links', to=orm['healers.Appointment'])),
        ...
        db.send_create_signal(u'healers', ['WellnessCenterGoogleEventLink'])
