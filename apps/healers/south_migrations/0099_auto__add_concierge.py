...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'healers_concierge', (
            (u'healer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['healers.Healer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'healers', ['Concierge'])


    def backwards(self, orm):
        # Deleting model 'Concierge'
        db.delete_table(u'healers_concierge')
