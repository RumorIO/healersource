...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('healers_location', 'room', self.gf('django.db.models.fields.CharField')(default='', max_length=12))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'Location.room' to match new field type.
        db.delete_column('healers_location', 'room')
        # Changing field 'Location.room'
        db.add_column('healers_location', 'room_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Room'], null=True))

        # Adding index on 'Location', fields ['room']
        try:
            db.create_index('healers_location', ['room_id'])
        except Exception:
            pass
