...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealerTimeslot.room'
        db.add_column(u'healers_healertimeslot', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['healers.Room'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealerTimeslot.room'
        db.delete_column(u'healers_healertimeslot', 'room_id')
