...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Healer.schedule_start_from_sunday_setting'
        db.add_column(u'healers_healer', 'schedule_start_from_sunday_setting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Healer.schedule_start_from_sunday_setting'
        db.delete_column(u'healers_healer', 'schedule_start_from_sunday_setting')
