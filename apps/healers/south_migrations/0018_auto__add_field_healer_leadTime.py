...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.leadTime'
        db.add_column('healers_healer', 'leadTime', self.gf('django.db.models.fields.PositiveIntegerField')(default=24), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.leadTime'
        db.delete_column('healers_healer', 'leadTime')
