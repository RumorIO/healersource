...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.treatment_length'
        db.add_column('healers_appointment', 'treatment_length', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.TreatmentTypeLength'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Appointment.treatment_type'
        db.add_column('healers_appointment', 'treatment_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['healers.TreatmentType']), keep_default=False)

        # Deleting field 'Appointment.treatment_length'
        db.delete_column('healers_appointment', 'treatment_length_id')
    ...
    models = {
        ...
        'healers.appointment': {
            ...
            'treatment_length': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['healers.TreatmentTypeLength']"})
        },
