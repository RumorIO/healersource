...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClientInvitation'
        db.create_table('healers_clientinvitation', (
        ...
        db.send_create_signal('healers', ['ClientInvitation'])


    def backwards(self, orm):
        
        # Deleting model 'ClientInvitation'
        db.delete_table('healers_clientinvitation')
