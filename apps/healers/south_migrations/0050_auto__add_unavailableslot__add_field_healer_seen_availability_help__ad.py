...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnavailableSlot'
#        db.create_table('healers_unavailableslot', (
#            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
#            ('start_date', self.gf('django.db.models.fields.DateField')()),
#            ('end_date', self.gf('django.db.models.fields.DateField')(null=True)),
#            ('start_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
#            ('end_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
#            ('repeat_period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True)),
#            ('repeat_every', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True)),
#            ('exceptions', self.gf('healers.fields.SeparatedValuesField')(null=True)),
#            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healers.Healer'])),
#            ('calendar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sync_hs.UnavailableCalendar'], null=True, blank=True)),
#            ('api', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
#            ('title', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
#            ('event_id', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
#        ))
#        db.send_create_signal('healers', ['UnavailableSlot'])
#
#        # Adding field 'Healer.seen_availability_help'
#        db.add_column('healers_healer', 'seen_availability_help', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
#
#        # Adding field 'Healer.seen_appointments_help'
#        db.add_column('healers_healer', 'seen_appointments_help', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
#
#        # Changing field 'TreatmentTypeLength.cost'
#        db.alter_column('healers_treatmenttypelength', 'cost', self.gf('django.db.models.fields.CharField')(max_length=10))
#
#        # Changing field 'TreatmentType.title'
#        db.alter_column('healers_treatmenttype', 'title', self.gf('django.db.models.fields.CharField')(max_length=42))

	    pass

    def backwards(self, orm):
        
        # Deleting model 'UnavailableSlot'
#        db.delete_table('healers_unavailableslot')
#
#        # Deleting field 'Healer.seen_availability_help'
#        db.delete_column('healers_healer', 'seen_availability_help')
#
#        # Deleting field 'Healer.seen_appointments_help'
#        db.delete_column('healers_healer', 'seen_appointments_help')
#
#        # Changing field 'TreatmentTypeLength.cost'
#        db.alter_column('healers_treatmenttypelength', 'cost', self.gf('django.db.models.fields.FloatField')())
#
#        # Changing field 'TreatmentType.title'
#        db.alter_column('healers_treatmenttype', 'title', self.gf('django.db.models.fields.CharField')(max_length=24))
