...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.google_event_link'
        db.add_column('healers_appointment', 'google_event_link', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appointment.google_event_link'
        db.delete_column('healers_appointment', 'google_event_link')
    ...
    models = {
        ...
        'healers.healer': {
            ...
            'google_calendar_link': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
