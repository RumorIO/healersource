...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Healer.manualAppointmentConfirmation'
        db.add_column('healers_healer', 'manualAppointmentConfirmation', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Healer.manualAppointmentConfirmation'
        db.delete_column('healers_healer', 'manualAppointmentConfirmation')
    ...
    models = {
        ...
        'healers.healer': {
            ...
            'manualAppointmentConfirmation': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
