...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TreatmentType.room'
        db.delete_column(u'healers_treatmenttype', 'room_id')

        # Adding M2M table for field rooms on 'TreatmentType'
        db.create_table(u'healers_treatmenttype_rooms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('treatmenttype', models.ForeignKey(orm[u'healers.treatmenttype'], null=False)),
            ('room', models.ForeignKey(orm[u'healers.room'], null=False))
        ))
        db.create_unique(u'healers_treatmenttype_rooms', ['treatmenttype_id', 'room_id'])


    def backwards(self, orm):
        # Adding field 'TreatmentType.room'
        db.add_column(u'healers_treatmenttype', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='treatment_types', null=True, to=orm['healers.Room']),
                      keep_default=False)

        # Removing M2M table for field rooms on 'TreatmentType'
        db.delete_table('healers_treatmenttype_rooms')
