...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('healers_appointment', 'last_modified_date', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Appointment.created_by'
        db.alter_column('healers_appointment', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Appointment.last_modified_by'
        db.alter_column('healers_appointment', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'Appointment.created_date'
        db.alter_column('healers_appointment', 'created_date', self.gf('django.db.models.fields.DateTimeField')(default=None))


    def backwards(self, orm):
        
        # Changing field 'Appointment.last_modified_date'
        db.alter_column('healers_appointment', 'last_modified_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Appointment.created_by'
        db.alter_column('healers_appointment', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Appointment.last_modified_by'
        db.alter_column('healers_appointment', 'last_modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Appointment.created_date'
        db.alter_column('healers_appointment', 'created_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'healers.appointment': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
