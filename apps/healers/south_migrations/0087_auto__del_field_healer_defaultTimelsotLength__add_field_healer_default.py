...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column 'Healer.defaultTimelsotLength' to 'Healer.defaultTimeslotLength'
        db.rename_column(u'healers_healer', 'defaultTimelsotLength', 'defaultTimeslotLength')

    def backwards(self, orm):
        # Renaming column 'Healer.defaultTimeslotLength' to 'Healer.defaultTimelsotLength'
        db.rename_column(u'healers_healer', 'defaultTimeslotLength', 'defaultTimelsotLength')
