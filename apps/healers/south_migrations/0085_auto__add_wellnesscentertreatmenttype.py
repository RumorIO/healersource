...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WellnessCenterTreatmentType'
        db.create_table(u'healers_wellnesscentertreatmenttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wellness_center_treatment_types', to=orm['healers.Healer'])),
        ))
        db.send_create_signal(u'healers', ['WellnessCenterTreatmentType'])

        # Adding M2M table for field treatment_types on 'WellnessCenterTreatmentType'
        db.create_table(u'healers_wellnesscentertreatmenttype_treatment_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wellnesscentertreatmenttype', models.ForeignKey(orm[u'healers.wellnesscentertreatmenttype'], null=False)),
            ('treatmenttype', models.ForeignKey(orm[u'healers.treatmenttype'], null=False))
        ))
        db.create_unique(u'healers_wellnesscentertreatmenttype_treatment_types', ['wellnesscentertreatmenttype_id', 'treatmenttype_id'])


    def backwards(self, orm):
        # Deleting model 'WellnessCenterTreatmentType'
        db.delete_table(u'healers_wellnesscentertreatmenttype')

        # Removing M2M table for field treatment_types on 'WellnessCenterTreatmentType'
        db.delete_table('healers_wellnesscentertreatmenttype_treatment_types')
    ...
    models = {
        ...
        u'healers.treatmenttype': {
            ...
            'is_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'rooms': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['healers.Room']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '42'})
        },
