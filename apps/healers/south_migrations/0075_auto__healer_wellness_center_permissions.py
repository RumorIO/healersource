...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field wellness_center_permissions on 'Healer'
        db.create_table('healers_healer_wellness_center_permissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('healer', models.ForeignKey(orm['healers.healer'], null=False)),
            ('wellnesscenter', models.ForeignKey(orm['healers.wellnesscenter'], null=False))
        ))
        db.create_unique('healers_healer_wellness_center_permissions', ['healer_id', 'wellnesscenter_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field wellness_center_permissions on 'Healer'
        db.delete_table('healers_healer_wellness_center_permissions')
    ...
    models = {
        ...
        'healers.healer': {
            ...
            'wellness_center_permissions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['healers.WellnessCenter']", 'null': 'True', 'blank': 'True'}),
        ...
        'healers.wellnesscenter': {
            'Meta': {'object_name': 'WellnessCenter', '_ormbases': ['healers.Healer']},
            'healer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['healers.Healer']", 'unique': 'True', 'primary_key': 'True'})
        },
        'healers.zipcode': {
