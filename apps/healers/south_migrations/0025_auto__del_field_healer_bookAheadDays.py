...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Healer.bookAheadDays'
        db.delete_column('healers_healer', 'bookAheadDays')


    def backwards(self, orm):
        
        # Adding field 'Healer.bookAheadDays'
        db.add_column('healers_healer', 'bookAheadDays', self.gf('django.db.models.fields.IntegerField')(default=30), keep_default=False)
