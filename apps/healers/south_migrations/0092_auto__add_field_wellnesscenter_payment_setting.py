...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WellnessCenter.payment_setting'
        db.add_column(u'healers_wellnesscenter', 'payment_setting',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WellnessCenter.payment_setting'
        db.delete_column(u'healers_wellnesscenter', 'payment_setting')
    ...
    models = {
        ...
        u'healers.healer': {
            ...
            'payment': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
