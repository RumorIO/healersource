...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field speciality_categories on 'HealingRequest'
        db.create_table(u'healing_requests_healingrequest_speciality_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('healingrequest', models.ForeignKey(orm[u'healing_requests.healingrequest'], null=False)),
            ('modalitycategory', models.ForeignKey(orm[u'modality.modalitycategory'], null=False))
        ))
        db.create_unique(u'healing_requests_healingrequest_speciality_categories', ['healingrequest_id', 'modalitycategory_id'])

        # Adding M2M table for field speciality_categories on 'HealingRequestSearch'
        db.create_table(u'healing_requests_healingrequestsearch_speciality_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('healingrequestsearch', models.ForeignKey(orm[u'healing_requests.healingrequestsearch'], null=False)),
            ('modalitycategory', models.ForeignKey(orm[u'modality.modalitycategory'], null=False))
        ))
        db.create_unique(u'healing_requests_healingrequestsearch_speciality_categories', ['healingrequestsearch_id', 'modalitycategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field speciality_categories on 'HealingRequest'
        db.delete_table('healing_requests_healingrequest_speciality_categories')

        # Removing M2M table for field speciality_categories on 'HealingRequestSearch'
        db.delete_table('healing_requests_healingrequestsearch_speciality_categories')
    ...
    models = {
        ...
        u'healing_requests.healingrequest': {
            ...
            'cost_per_session': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'speciality_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['modality.ModalityCategory']", 'symmetrical': 'False'}),
        ...
        u'modality.modality': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rejected': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
