...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HealingRequest.cost_per_session'
        db.alter_column(u'healing_requests_healingrequest', 'cost_per_session', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'HealingRequestSearch.cost_per_session'
        db.alter_column(u'healing_requests_healingrequestsearch', 'cost_per_session', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'HealingRequest.cost_per_session'
        db.alter_column(u'healing_requests_healingrequest', 'cost_per_session', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'HealingRequestSearch.cost_per_session'
        db.alter_column(u'healing_requests_healingrequestsearch', 'cost_per_session', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
