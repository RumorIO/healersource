...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HealingRequestSearch'
        db.create_table(u'healing_requests_healingrequestsearch', (
            ...
            ('near_my_location', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('only_my_specialities', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('saved', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'healing_requests', ['HealingRequestSearch'])

        # Adding M2M table for field specialities on 'HealingRequestSearch'
        db.create_table(u'healing_requests_healingrequestsearch_specialities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('healingrequestsearch', models.ForeignKey(orm[u'healing_requests.healingrequestsearch'], null=False)),
            ('modality', models.ForeignKey(orm[u'modality.modality'], null=False))
        ))
        db.create_unique(u'healing_requests_healingrequestsearch_specialities', ['healingrequestsearch_id', 'modality_id'])

        # Deleting field 'HealingRequest.client'
        db.delete_column(u'healing_requests_healingrequest', 'client_id')

        # Adding field 'HealingRequest.user'
        db.add_column(u'healing_requests_healingrequest', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HealingRequestSearch'
        db.delete_table(u'healing_requests_healingrequestsearch')

        # Removing M2M table for field specialities on 'HealingRequestSearch'
        db.delete_table('healing_requests_healingrequestsearch_specialities')


        # User chose to not deal with backwards NULL issues for 'HealingRequest.client'
        raise RuntimeError("Cannot reverse this migration. 'HealingRequest.client' and its values cannot be restored.")
        # Deleting field 'HealingRequest.user'
        db.delete_column(u'healing_requests_healingrequest', 'user_id')
    ...
    models = {
        ...
        u'healing_requests.healingrequestsearch': {
            'Meta': {'object_name': 'HealingRequestSearch'},
            'cost_per_session': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['healers.Zipcode']", 'null': 'True', 'blank': 'True'}),
            'near_my_location': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'only_my_specialities': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'remote_healing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
