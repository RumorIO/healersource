...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealingRequest.status'
        db.add_column(u'healing_requests_healingrequest', 'status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealingRequest.status'
        db.delete_column(u'healing_requests_healingrequest', 'status')
