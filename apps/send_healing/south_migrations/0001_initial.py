...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentHealing'
        db.create_table(u'send_healing_senthealing', (
            ...
            ('sent_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_healing', to=orm['clients.Client'])),
        ...
        db.send_create_signal(u'send_healing', ['SentHealing'])

        # Adding model 'GhpSettings'
        db.create_table(u'send_healing_ghpsettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='ghp_settings', unique=True, to=orm['auth.User'])),
            ('send_to_ghp_members', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_to_my_fb_friends', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('i_want_to_receive_healing', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'send_healing', ['GhpSettings'])

        # Adding model 'HealingPersonStatus'
        db.create_table(u'send_healing_healingpersonstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person_content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('person_object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal(u'send_healing', ['HealingPersonStatus'])


    def backwards(self, orm):
        # Deleting model 'SentHealing'
        db.delete_table(u'send_healing_senthealing')

        # Deleting model 'GhpSettings'
        db.delete_table(u'send_healing_ghpsettings')

        # Deleting model 'HealingPersonStatus'
        db.delete_table(u'send_healing_healingpersonstatus')
