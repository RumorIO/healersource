...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GhpSettings.send_to_my_favorites_only'
        db.add_column(u'send_healing_ghpsettings', 'send_to_my_favorites_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GhpSettings.send_to_my_favorites_only'
        db.delete_column(u'send_healing_ghpsettings', 'send_to_my_favorites_only')
