...
//                        tp.left = pos.left + pos.width / 2 - 15; DGL
						tp.left = pos.left + pos.width / 2 - 42;
					} else {
//                        tp.left = pos.left + pos.width / 2 - actualWidth + 15; DGL
						tp.left = pos.left + pos.width / 2 - actualWidth + 42;
					}
				}
...
//            }
		...
		function enter() {
			var tipsy = get(this);
			if(!tipsy || tipsy.options['trigger'] == 'manual') return;
			tipsy.hoverState = 'in';
		...
		if (!options.live)
			this.each(function() {
				tipsy = new Tipsy(this, $.fn.tipsy.elementOptions(this, options));
