 ...
 *    - https://groups.google.com/group/jquery-week-calendar
 * have a look to the wiki for documentation:
 *    - https://wiki.github.com/themouette/jquery-week-calendar/
 * something went bad ? report an issue:
 *    - https://github.com/themouette/jquery-week-calendar/issues
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _setupEventCreationForWeekDay: function($weekDay) {
          ...
          $weekDay.mousedown(function(event) {
            var $target = $(event.target);
				if (typeof $target.data('calEvent')!='undefined' && $target.data('calEvent').readOnly)
      ...
      _renderEvents: function(data, $weekDayColumns) {
          ...
          $.each(eventsToRender, function(i, calEvent) {
              ...
              //thanks to https://github.com/fbeauchamp/jquery-week-calendar
      ...
      /*
        ...
        * https://jacwright.com/projects/javascript/date_format
        */
